...
export class Test1692110457533 implements MigrationInterface {
  name = 'Test1692110457533';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "album" ("id" uuid NOT NULL, "name" character varying NOT NULL, "year" integer NOT NULL, "artistId" uuid, CONSTRAINT "PK_58e0b4b8a31bb897e6959fe3206" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "track" ("id" uuid NOT NULL, "name" character varying NOT NULL, "duration" integer NOT NULL, "artistId" uuid, "albumId" uuid, CONSTRAINT "PK_0631b9bcf521f8fab3a15f2c37e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorite_artist" ("id" character varying NOT NULL, "artistId" uuid, CONSTRAINT "REL_abb58fab7ade1c31939a54e134" UNIQUE ("artistId"), CONSTRAINT "PK_62b62ed38bf0e76f54a5609f9ae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorite_album" ("id" character varying NOT NULL, "albumId" uuid, CONSTRAINT "REL_25b9b6014e56d858b32863836c" UNIQUE ("albumId"), CONSTRAINT "PK_8b1f4c021579fa1631fcc0b6377" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorite_track" ("id" character varying NOT NULL, "trackId" uuid, CONSTRAINT "REL_8cdd0f83efe8f5df377eeab9b7" UNIQUE ("trackId"), CONSTRAINT "PK_919a46033d84cebe3f7c405fe50" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
